...
from transformers import (AutoModelForTokenClassification, AutoTokenizer,
                          DataCollatorForTokenClassification, PreTrainedModel,
...
def get_batch_token_probabilities(texts: List[str], tokenizer: PreTrainedTokenizer, model: PreTrainedModel, aggregate_subwords: bool = True, batch_size: int = 32, device: str = 'cuda') -> List[Dict[str, Union[List[str], np.ndarray]]]:
    """
