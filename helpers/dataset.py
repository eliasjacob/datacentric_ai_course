...
class BaseDataset(ABC):
    ...
    def __init__(
        ...
        features: List[str],
        split: str,
        label_matrix: Optional[np.array],
        true_labels: Optional[np.array] = None,
        transform_fn: Optional[Callable] = None,
        embeddings: Optional[np.array] = None,
        clean_unlabeled: bool = True,
        labeling_functions: Optional[List[str]] = None,
        label_model: Optional[Any] = None,
        label_model_fit_kwargs: Optional[dict] = None,
        init: bool = True,
        ...
        Args:
            ...
            label_matrix (Optional[np.array]): Label matrix of shape (num_examples, num_classes).
            true_labels (Optional[np.array], optional): True labels of shape (num_examples,). Defaults to None.
            transform_fn (Optional[Callable], optional): Function to transform examples. Defaults to None.
            embeddings (Optional[np.array], optional): Embeddings of shape (num_examples, embedding_dim). Defaults to None.
            clean_unlabeled (bool, optional): Whether to remove unlabeled examples. Defaults to True.
            labeling_functions (Optional[List[str]], optional): List of label functions. Defaults to None.
            label_model (Optional[Any], optional): The label model. Defaults to None.
            init (bool, optional): Whether to initialize the label model. Defaults to True.
            sample_frac (Optional[float], optional): Fraction of examples to sample. Defaults to None.
        """
        pass
...
class WeakDataset(BaseDataset):
    def __init__(
        ...
        Args:
            ...
            embeddings (Optional[np.array], optional): Embeddings of shape (num_examples, embedding_dim). Defaults to None.
            clean_unlabeled (bool, optional): Whether to remove unlabeled examples. Defaults to True.
            labeling_functions (Optional[List[str]], optional): List of label function. Defaults to None.
            label_model (Optional[Any], optional): The label model. Defaults to None.
            label_model_fit_kwargs (Optional[dict], optional): Keyword arguments for fitting the label model. Defaults to None.
            init (bool, optional): Whether to initialize the label model. Defaults to True.
            sample_frac (Optional[float], optional): Fraction of examples to sample. Defaults to None.
        """
        super().__init__(
